          ...
          <div class="row align-items-center">
                ...
                <form action="loginVal.php" method="post">
                    <div class="input-group mb-3">
                        <input type="text" name="user_name" class="form-control form-control-lg bg-light fs-6" placeholder="User Name">
                    </div>
                    ...
                    <div class="input-group mb-5 d-flex justify-content-between">
                        ...
                        <div class="forgot">
                            <small><a href="recovery.php">Forgot Password?</a></small>
                        </div>
                    </div>
                    <div class="input-group mb-3">
                    ...
                    <div class="row">
                        <small>Don't have account? <a href="regiter.php">Sign Up</a></small>
                    </div>
